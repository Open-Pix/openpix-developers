...
- [ ] Register a WooCommerce Callback URL on OpenPix. Example: [https://meusite.com.br/wc-api/WC_OpenPix_Pix_Gateway](https://meusite.com.br/wc-api/WC_OpenPix_Pix_Gateway)
