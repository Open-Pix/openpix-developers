...
sidebar_position: 1
title: How to Create a Subscription with COBV Using the API?
tags:
  - subscription
  - cobv
  - recurrence
...
To create a new subscription with COBV (Charge Overdue Banking Billet) using the API, you need to make a POST call to the `/api/v1/subscriptions` endpoint.
...
- **`chargeType`**: The type of charge you want to generate. In this case of COBV, you should specify the type `OVERDUE`.
