...
A maneira mais conveniente de baixar a extensão em sua loja é acessando o [marketplace oficial](https://www.opencart.com/index.php?route=marketplace/extension/info&extension_id=45252&filter_search=openpix) do OpenCart. Lá, você encontrará a extensão pronta para ser baixada e instalada com facilidade.
