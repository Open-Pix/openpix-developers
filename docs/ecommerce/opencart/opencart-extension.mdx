...
Ao realizar uma compra em sua loja OpenCart, o cliente será redirecionado para a página de sucesso.
...
![QrCode do Pix na página de sucesso do checkout](/img/ecommerce/opencart/checkout-success-js-plugin.png)
