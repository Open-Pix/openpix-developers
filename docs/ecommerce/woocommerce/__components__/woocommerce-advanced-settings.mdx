...
O [`correlationID`](../../../concepts/correlation-id.md) será passado na URL e, com esse identificador, você poderá manipular qual é a cobrança em questão utilizando nossas [APIs](/api).
