...
Acesse a página de [lançamentos](https://github.com/Open-Pix/openpix-easy-digital-downloads/releases/latest) no GitHub e baixe o arquivo ZIP `openpix-easy-digital-downloads.zip` da última versão.
...
Nesta página é necessário informar seu [AppID](../plugin/app-id) da OpenPix. Veja [como criar uma nova integração do tipo plugin](../apis/getting-started-api).
