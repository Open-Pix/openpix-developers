...
É necessário o cliente informar seu endereço ao utilizar o método de pagamento Pix parcelado.

Cada endereço precisa ter 4 linhas:
  - rua
  - número
  - complemento
  - bairro
...
### Realizar Pedido com Pix parcelado
