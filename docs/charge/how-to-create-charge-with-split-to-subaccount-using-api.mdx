...
- **`splits`**: Um array contendo as configurações de split realizado na hora do recebimento. No caso de split para sub contas 
**_o array de splits deve sempre conter somente um elemento_**.
...
fetch('https://api.openpix.com.br/api/v1/charge', {
  ...
  body: JSON.stringify({
    ...
    correlationID: 'c782e0ac-833d-4a89-9e73-9b60b2b41d3a',
    splits: [
      { pixKey: 'destinatario@openpix.com.br', value: 15, splitType: "" },
    ],
  }),
  headers: {
