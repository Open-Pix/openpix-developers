...
title: Como usar a API para criar uma cobrança com desconto?
tags:
  - concept
  - api
  - discount
...
## Criar cobrança com desconto via API

Para criar uma cobrança Pix com desconto, você utiliza o _endpoint_ `/api/v1/charge` da API.

Você pode acessar [aqui](https://developers.openpix.com.br/api#tag/charge/paths/~1api~1v1~1charge/post)
a documentação referente a esse _endpoint_.

Os campos obrigatórios para criar uma cobrança Pix com desconto são os seguintes:

- **`type`**: O tipo de cobrança Pix.
...
- **`discountSettings`**: O objeto que contém as configurações de desconto da cobrança Pix.
...
Atualmente contamos com os seguintes _enums_ para especificar a modalidate do desconto:
