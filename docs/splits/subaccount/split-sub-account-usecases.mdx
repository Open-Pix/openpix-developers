...
O split de sub-contas é uma funcionalidade que permite que o recebimento de uma cobrança seja dividido entre chaves pix. Entenda mais aqui: [O que é um split](../split-introduction.md)

:::info
Entenda melhor sobre qual tipo de split utilizar [aqui](../split-introduction.md#tipos-de-split)
:::
